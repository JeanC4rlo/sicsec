...
function addArquivo(inpNota, btnEnviar) {
    ...
    btnBaixarArquivo.addEventListener("click", () => downloadArquivo(dadosDesempenho.arquivoId, dadosDesempenho.respostaId));
...
function downloadArquivo(arquivoId, respostaId) {
    const url = `/api/arquivo/${arquivoId}/resposta/${respostaId}`;
