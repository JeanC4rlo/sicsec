function initSectionTurmas() {
    ...
    const fotoPadrao = "/images/default-user.png";
    let listaTurmas;
    let materiaAtual;
    let localAtual;
    let horarioAtual;
    ...
    function highlightTurmasOption(tabId) {
        const buttons = document.querySelectorAll(".turmas header button");
    ...
    function openTurmasTab(tabId) {
        const tabs = document.querySelectorAll(".turmas .wrapper > div");
        tabs.forEach(tab => {
    ...
    function initTurmasTabs() {
        const turmasButtons = document.querySelectorAll(".turmas header button");
